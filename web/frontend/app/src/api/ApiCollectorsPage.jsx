...
export const fetchRuleAdd = (data) => {
  return new Promise(async (resolve, reject) => {
    try {
      const response = await api.post('/collectors/rule', data);
      resolve(response.data);
    } catch (error) {
      console.error(error);
      reject(error);
...
export const fetchRuleDel = (id) => {
  return new Promise(async (resolve, reject) => {
    try {
      const response = await api.delete(`/collectors/rule/${id}`);
      resolve(response.data);
    } catch (error) {
      console.error(error);
      reject(error);
...
export const fetchRuleCopy = (id) => {
  return new Promise(async (resolve, reject) => {
    try {
      const response = await api.post(`/collectors/copy/${id}`);
      resolve(response.data);
    } catch (error) {
      console.error(error);
      reject(error);
...
export const fetchRuleEdit = (id, data) => {
  return new Promise(async (resolve, reject) => {
    try {
      const response = await api.put(`/collectors/rule/${id}`, data);
      resolve(response.data);
    } catch (error) {
      console.error(error);
      reject(error);
...
export const fetchRuleImport = (setData, data) => {
  return new Promise(async (resolve, reject) => {
    try {
      api.put('/collectors/import', data)
        .then(response => {
          setData(response.data)
          resolve(response.data);
        });
...
export const fetchRuleImportCSV = (setData, data) => {
  return new Promise(async (resolve, reject) => {
    try {
      api.put('/collectors/import_csv', data)
        .then(response => {
          setData(response.data)
          resolve(response.data);
        });
...
export const fetchDeleteAll = (id) => {
  return new Promise(async (resolve, reject) => {
    try {
      const response = await api.delete(`/collectors/delete_all`);
      resolve(response.data);
    } catch (error) {
      console.error(error);
      reject(error);
