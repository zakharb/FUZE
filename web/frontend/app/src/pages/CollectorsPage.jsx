...
import {
  ...
  fetchRuleImport,
  fetchDeleteAll,
  } from "../api/ApiCollectorsPage.jsx"
    ...
    <Container sx={{ minWidth: '1000px'}} maxWidth="xl">
      <div className="table">
        <Grid container sx={{padding: 3}} >
          ...
          <Grid item xl={6}>
            <Grid container justifyContent="flex-end" alignServices="center">
              <TextField
                id="standard-basic"
                label="Search"
                variant="standard"
...
function EditForm({ NormRules, formData, setFormData, row, data, onClose }) {
  ...
  const handleAddService = () => {
    const newServiceData = { [newService]: 1 };
    setNewService('');
    setFormData((prevState) => ({
      ...prevState,
      services: [...prevState.services, newServiceData],
    }));
  };
          ...
          <Grid container spacing={2}>
            ...
            <Grid item xl={3}>
              <TextField
                ...
                id="standard-basic" 
                label="Configuration"
                onChange={handleServiceChange(index, "conf")}
                variant="standard"
              />
            </Grid>
